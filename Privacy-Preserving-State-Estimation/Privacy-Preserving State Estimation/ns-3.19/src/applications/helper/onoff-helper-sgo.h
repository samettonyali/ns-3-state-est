/* 
 * File:   onoff-helper-sgo.h
 * Author: samettonyali
 *
 * Created on August 11, 2014, 2:05 PM
 */
...
#ifndef ONOFF_HELPER_SGO_H
#define	ONOFF_HELPER_SGO_H
...
public:
   ...
   *        to.
   */
  OnOffHelperSGO (std::string protocol, Address address);
  ...
  */
  ...
  //void  SetObfsValues (int16_t value);
